 ...
 * @property StudentTransaction[] $studentTransactions
...
class User extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'employeeTransactions' => array(self::HAS_MANY, 'EmployeeTransaction', 'employee_transaction_user_id'),
			'studentTransactions' => array(self::HAS_MANY, 'StudentTransaction', 'student_transaction_user_id'),
			'userOrganization' => array(self::BELONGS_TO, 'Organization', 'user_organization_id'),
		);
	}
