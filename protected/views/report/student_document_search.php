...
<?php
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'document_category',CHtml::listData(DocumentCategoryMaster::model()->findAll(array('condition'=>'docs_category_organization_id='.Yii::app()->user->getState('org_id'))),'doc_category_id','doc_category_name'), array('empty' => 'Select Document'));?>
		<span class="status">&nbsp;</span>
