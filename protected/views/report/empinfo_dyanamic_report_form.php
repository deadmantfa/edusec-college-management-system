...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo CHtml::dropDownList('city', null, City::items(), array('empty' => 'Select City','tabindex'=>2));?>
<span class="status">&nbsp;</span>
		
		<?php echo CHtml::label('Category',''); ?>
		<?php echo CHtml::dropDownList('category', null, Category::items(), array('empty' => 'Select Category','tabindex'=>5));?>
	</div>
