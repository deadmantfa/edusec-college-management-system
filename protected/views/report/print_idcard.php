...
<div class="main">
	...
	<div class="front_content">
		<div class="contentpic">
			<?php echo CHtml::image("../stud_images/".$studphoto,"no-images",array("width"=>"30px","height"=>"35px"));?>
		</div>
	...
	<div class="footer-sign">
		...
		<div class="front_sign">
			<?php
				  if($org_id == 1)
					echo CHtml::image(Yii::app()->baseUrl.'/org_sign/hansabapricipalsign.png',"",array("width"=>"100px"));
				  if($org_id == 2)
					echo CHtml::image(Yii::app()->baseUrl.'/org_sign/jasodaba-principal.png',"",array("width"=>"100px"));
			?>
		</div>			
