...
<div class="row">
<input type="checkbox" name="emp_info[]" id="category_name" value="category_name" /> &nbsp;Category
</div>
...
<div class="row">
<input type="checkbox" name="emp_info[]" id="employee_address_p_line1" value="employee_address_p_line1" /> &nbsp;Permenent Address
</div>
