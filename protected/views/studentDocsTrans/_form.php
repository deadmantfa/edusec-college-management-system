...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
	...
	'options'=>array(
		...
		'close' => 'js:function(event, ui) { location.href = "'.Yii::app()->createUrl("studentTransaction/update/".$_REQUEST['id']).'"; }'
	),
));
?>
<style>
.row #StudentDocs_student_docs_path {
  width: 200px;
}
</style>
<div class="form">
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($stud_doc,'doc_category_id',CHtml::listData(DocumentCategoryMaster::model()->findAll(array('condition'=>'docs_category_organization_id='.Yii::app()->user->getState('org_id'))),'doc_category_id','doc_category_name'),array('empty' => 'Select Category')); ?><span class="status">&nbsp;</span>
