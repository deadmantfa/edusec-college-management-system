...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'branch_tag_name',array('size'=>25,'maxlength'=>20)); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'pass_out_sem',array(""=>"Select Semester","2"=>"2","4"=>"4","6"=>"6","8"=>"8","9"=>"9"))
			?>
		<span class="status">&nbsp;</span>
