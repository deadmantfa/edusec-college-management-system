<div class = "row_all_v">
	<div class="rowv">
		...
		<div class="rown">
			<?php 
			if($model->Rel_Stud_Info->student_guardian_name != null)
				echo $model->Rel_Stud_Info->student_guardian_name.'<br>'; 
			else
				echo 'Not Set</br>';
			?>
		</div>
	...
	<div class="rowv">
		...
		<div class="rown">
			<?php 
			if($model->Rel_Stud_Info->student_guardian_relation != null)
				echo $model->Rel_Stud_Info->student_guardian_relation.'<br>'; 
			else
				echo 'Not Set</br>';
			?>
		</div>
...
<div class = "row_all_v">
	<div class="rowv">
		...
		<div class="rown">
			<?php 
			if($model->Rel_Stud_Info->student_guardian_income != null)
				echo $model->Rel_Stud_Info->student_guardian_income. '<br>'; 
			else
				echo 'Not Set</br>';
			?>
		</div>
...
<div class = "row_all_vm">
	<div class="rowv">
		...
		<div class="rown">
			<?php 
			if($model->Rel_Stud_Info->student_guardian_mobile != null)
				echo $model->Rel_Stud_Info->student_guardian_mobile.  '<br>'; 
			else
				echo "Not Set</br>";
			?>
