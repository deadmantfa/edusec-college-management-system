...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note">Select any radio-button to enable textbox<span class="required">*</span></p>
	<div class="row">
		<?php echo CHtml::label('Roll No.','');?>
		<input type="radio" name="studentradio" id="btn1" value="1" onclick="valuealert1()"/>
		<?php //echo $form->textField($model,'student_roll_no',array('tabindex'=>1,'disabled'=>'disabled')); 
echo CHtml::textField('roll_no', null,  array('tabindex'=>1,'disabled'=>'disabled'));?><span class="status">&nbsp;</span>
	</div>

	<div class="row">
		<?php echo CHtml::label('Enrollment No.','');?>
