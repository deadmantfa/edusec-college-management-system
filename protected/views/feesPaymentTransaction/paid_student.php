<?php
$this->menu=array(
	array('label'=>'', 'url'=>array('paid','paidExport'=>'paidpdf','branch_id'=>$_REQUEST['branch_id'],'acm_id'=>$_REQUEST['acm_id'],'quota'=>$_REQUEST['quota'],'acm_name_id'=>$_REQUEST['acm_name_id']),'linkOptions'=>array('class'=>'export-pdf','title'=>'Export to PDF','target'=>'_blank')),
	array('label'=>'', 'url'=>array('paid','paidexportexcel'=>'paidexcel','branch_id'=>$_REQUEST['branch_id'],'acm_id'=>$_REQUEST['acm_id'],'quota'=>$_REQUEST['quota'],'acm_name_id'=>$_REQUEST['acm_name_id']),'linkOptions'=>array('class'=>'export-excel','title'=>'Export to Excel','target'=>'_blank')),
);
...
?>
<tr style="font-size:18px;" ><th colspan =4 >Total Amount</th><th><?php echo $grandpayable;?></th><th><?php echo $grandpaidtotal;?></th><th><?php echo $grandoutstandtotal;?></th></tr>
</table>
<?php 
}
else 
