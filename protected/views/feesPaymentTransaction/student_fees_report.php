...
$this->breadcrumbs=array(
	...
	if(Yii::app()->user->checkAccess('FeesPaymentTransaction.StudentFeesReport'))
	{	
	$this->menu=array(
		array('label'=>'', 'url'=>array('StudentFeesReport','StudentFeesexport'=>'studentfeespdf','en_no'=>$student_data),'linkOptions'=>array('class'=>'export-pdf','title'=>'Export to PDF')),
		array('label'=>'', 'url'=>array('StudentFeesReport','studentfeesexportexcel'=>'studentfeespdf','en_no'=>$student_data),'linkOptions'=>array('class'=>'export-excel','title'=>'Export to Excel')),
	);
	}
	...
	if(!Yii::app()->user->getState('stud_id'))
	{
		...
		echo "</br>";
		echo CHtml::link('GO BACK',Yii::app()->createUrl('feesPaymentTransaction/StudentFeesReport'),array());
	echo "</br></br>";
	}	
