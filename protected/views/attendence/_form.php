...
<?php // var_dump($row1); ?>
	...
	<?php 
	/*
	$period = TimeTable::model()->findByAttributes(array('time_table_organization_id'=>Yii::app()->user->getState('org_id')));
	...
	$period_value = $period['No_of_Lec'];
	$period1 = array();	
	for($i=1;$i<=$period_value;$i++)
	{
		$period1[$i] = $i;	
...
?>
		<div class="row">
			...
			<?php echo $form->checkBox($model, 'st_id[]', array('value'=>$stud_id, 'uncheckValue'=>null)); ?>
