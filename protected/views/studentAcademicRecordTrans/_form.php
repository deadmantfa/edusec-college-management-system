...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php
		     ...
		     {
			$query = 'qualification_id  not in(select student_academic_record_trans_qualification_id from student_academic_record_trans where qualification_id <>'.$model->student_academic_record_trans_qualification_id.' ) and qualification_organization_id='.$org.'';
		     }
		     else
		     $query = 'qualification_id  not in(select student_academic_record_trans_qualification_id from student_academic_record_trans) and qualification_organization_id='.$org.'';
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'student_academic_record_trans_record_trans_year_id',Year::items(), array('empty' => 'Select Year','tabindex'=>3)); ?><span class="status">&nbsp;</span>
