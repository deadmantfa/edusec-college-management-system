...
class EmployeeAcademicRecordTransController extends RController
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['EmployeeAcademicRecordTrans']))
		{
			...
			if($model->save())
				$this->redirect(array('employeeTransaction/update','id'=>$_REQUEST['id']));
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['EmployeeAcademicRecordTrans']))
		{
			$model->attributes=$_POST['EmployeeAcademicRecordTrans'];
			if($model->save())
				$this->redirect(array('employeeTransaction/update','id'=>$model->employee_academic_record_trans_user_id));
		}
