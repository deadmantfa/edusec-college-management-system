...
//===============student sms===============
	...
	public function actionstudentcertificateGenerateExcel()
	{
		...
		Yii::app()->request->sendFile("StudentCertificateDetails.xlsx",
	...
	public function actionEmpcertificateGenerateExcel()
	{
		...
		Yii::app()->request->sendFile("EmployeeCertificateDetails.xlsx",
	...
	public function actionScheduleTimingGenerateExcel()
	{
		...
		Yii::app()->request->sendFile("ScheduleTiming.xlsx",
	...
	public function actionElectivesubjectGenerateExcel()
	{
		...
		Yii::app()->request->sendFile("ElectiveSubjectDetails.xlsx",
