...
class FeesPaymentCashController extends Controller
{
	/**
	...
	{
/*		$dataProvider=new CActiveDataProvider('FeesPaymentCash');
		$this->render('index',array(
			'dataProvider'=>$dataProvider,
		));*/
		$model=new FeesPaymentCash('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FeesPaymentCash']))
			$model->attributes=$_GET['FeesPaymentCash'];
