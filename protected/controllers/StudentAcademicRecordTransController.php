...
class StudentAcademicRecordTransController extends RController
{
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['StudentAcademicRecordTrans']))
		{
			$model->attributes=$_POST['StudentAcademicRecordTrans'];
			if($model->save())
				$this->redirect(array('studentTransaction/update','id'=>$model->student_academic_record_trans_stud_id));
		}
...
/*		$dataProvider=new CActiveDataProvider('StudentAcademicRecordTrans');
	...
	public function actionStudentAcademicRecords()
	{
		...
		$this->render('studenntacademicrecord',array(
			'studenntacademicrecord'=>$model,
		));
	}
