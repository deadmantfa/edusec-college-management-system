...
class LeftDetainedPassStudentTable extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('student_id, left_detained_shift_id, status_id, sem, academic_term_period_id, created_by, oraganization_id', 'numerical', 'integerOnly'=>true,'message'=>""),
			array('left_detained_pass_student_cancel_date','safe'),
			array('remarks','safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, student_id, student_transaction_branch_id, status_id, sem, academic_term_period_id,academic_term_period,creation_date, created_by, oraganization_id, student_first_name, status_name, academic_term_name, academic_term_period,left_detained_shift_id,left_detained_pass_student_cancel_date,remarks, student_enroll_no, student_roll_no,student_last_name,student_mobile_no,student_email_id_1', 'safe', 'on'=>'search,leftsmssearch'),
		);
	}
